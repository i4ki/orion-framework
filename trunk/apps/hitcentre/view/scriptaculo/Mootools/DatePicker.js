 ...
 * DatePicker
 * @author Rick Hopkins
 * @modified by Micah Nolte and Martin Vaina
 * @version 0.3.2
...
var DatePicker = new Class({
	...
	initialize: function(dp){
		...
		this.dayNames = ['Domingo', 'Segunda', 'Ter�a', 'Quarta', 'Quinta', 'Sexta', 'Sabado'];
		this.daysInMonth = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31];
		this.format = 'dd/mm/yyyy';
		this.monthNames = ['Janeiro', 'Fevereiro', 'Mar�o', 'Abril', 'Maio', 'Junho', 'Julho', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Dezembro'];
