<?php /* Smarty version 2.6.23, created on 2009-09-06 10:51:33
      ...
      <fieldset id="msg_register_user">
		...
		<table class="tbmsg">
			<tr>
				...
				<td class="input"><input type="text" name="msg_register_title" id="msg_register_title" value="<?php echo $this->_tpl_vars['portal']['msg_register_title']; ?>
" size="32" /></td>
			</tr>
			<tr>
