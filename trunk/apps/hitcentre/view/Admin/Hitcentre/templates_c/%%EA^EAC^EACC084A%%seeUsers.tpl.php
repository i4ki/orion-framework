...
<h3>Usuários</h3>
	<table width="100%">
		<thead>
			<tr>
            	<th width="40px"><a href="Admin/Users/<?php echo $this->_tpl_vars['resultsPerPage']; ?>
...
img/icons/arrow_down_mini.gif" width="16" height="16" align="absmiddle" /></a></th>
            	<th><a href="Admin/Users/<?php echo $this->_tpl_vars['resultsPerPage']; ?>
/<?php echo $this->_tpl_vars['page']; ?>
...
">Email</a></th>
                <th width="70px"><a href="Admin/Users/<?php echo $this->_tpl_vars['resultsPerPage']; ?>
/<?php echo $this->_tpl_vars['page']; ?>
/OrderBy/group/<?php echo $this->_tpl_vars['order']; ?>
">Grupo</a></th>
...
img/icons/user_delete.png" title="Deletar usuário" width="16" height="16" /></a></td>
    ...
    <div id="pager">
    	Página <a href="Admin/Users/<?php echo $this->_tpl_vars['resultsPerPage']; ?>
...
" />
    	<a href="Admin/Users/<?php echo $this->_tpl_vars['resultsPerPage']; ?>
/<?php echo $this->_tpl_vars['page']+1; ?>
"><img src="<?php echo $this->_tpl_vars['pathAdmin']; ?>
img/icons/arrow_right.gif" width="16" height="16" /></a>de <strong><?php echo $this->_tpl_vars['totalPage']; ?>
</strong>
    	páginas&nbsp;|&nbsp;Visualizar <select name="resultsPerPage" id="resultsPerPage" onchange="window.location.href='Admin/Users/'+this.value+'/<?php echo $this->_tpl_vars['page']; ?>
'">
