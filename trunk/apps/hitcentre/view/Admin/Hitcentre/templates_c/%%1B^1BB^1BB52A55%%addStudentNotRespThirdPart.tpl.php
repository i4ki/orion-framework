<?php /* Smarty version 2.6.23, created on 2009-09-07 13:48:14
         compiled from actions/School/Entries/addStudentNotRespThirdPart.tpl */ ?>
...
" /></td>
			...
			<tr>
				...
				<td class="input">	<select name="course" id="course" style="width:200px;" class="<?php echo '{validate:{required:true}}'; ?>
">
...
" /></td>
			...
			<tr>
				...
				<td class="input"><input type="pays_material" id="pays_material" />
			</tr>
			<tr>
