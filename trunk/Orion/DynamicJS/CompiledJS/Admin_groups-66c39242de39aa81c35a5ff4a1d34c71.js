document.charset = 'utf-8';
	...
	function loadResources( service, pattern ) {
		...
		Ajax.prototype.beforeSend = function() {
			$j('#divRoleResource').html('<center><img src="http://localhost/hitcentre/View/Admin/Hitcentre/templates/img/ajax-loader.gif" /></center>');
		}
		...
		var ajax = new Ajax('http://localhost/hitcentre/Admin/Manager/Groups/Get/'+service+'/'+pattern+'/null/Ajax');
		ajax.send();
	...
	function savePermission() {
		...
		ajax = new Ajax('http://localhost/hitcentre/Admin/Manager/Groups/SavePermission/null/null/null/Ajax');
		ajax.send(null, data);
		disableNameGroup();
	}
	...
	function selectPerfil( role ) {
		Ajax.prototype.beforeSend = function() {
			$j('#loader').html('<img src="http://localhost/hitcentre/View/Admin/Hitcentre/templates/img/ajax-loader.gif\" />');
		}
		Ajax.prototype.success = function( response ) {
			$j('#divRoleResource').html(response);
		}
	...
	function gravar() {
		...
		if(name == null || name =='') {
			...
			location.href="Admin/Users/Groups/Save/By/Cookies";
		}
	}