document.charset = 'utf-8';
	...
	function loadResources( service, pattern ) {
		...
		Ajax.prototype.beforeSend = function() {
			$j('#divRoleResource').html('<center><img src="http://localhost/loja_nova/View/Admin/Hitcentre/templates/img/ajax-loader.gif" /></center>');
		}
		...
		var ajax = new Ajax('http://localhost/loja_nova/Admin/Manager/Groups/Get/'+service+'/'+pattern+'/null/Ajax');
		ajax.send();
	...
	function savePermission() {
		...
		ajax = new Ajax('http://localhost/loja_nova/Admin/Manager/Groups/SavePermission/null/null/null/Ajax');
		ajax.send(null, data);
		disableNameGroup();
	}
	...
	function selectPerfil( role ) {
		Ajax.prototype.beforeSend = function() {
			$j('#loader').html('<img src="http://localhost/loja_nova/View/Admin/Hitcentre/templates/img/ajax-loader.gif\" />');
		}
		Ajax.prototype.success = function( response ) {
			$j('#divRoleResource').html(response);
		}
