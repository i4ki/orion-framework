...
class OrionSecurity_Restricted {
	protected $user;
	protected $uniqueKEY;
	protected $url;
	...
	public static function shutdownAllSessions() {
		...
		OrionSecurity_Restricted::startSession('admin',true);
	...
	public function isLogged() {
 	...
 	public static function generateUniqueKEY( 	$str, 
 		...
 		$hash_useragent = OrionSecurity_Restricted::generateKeyForUserAgent();
 	...
 	protected function securityGlobalVars() {
 		$_COOKIE 	= OrionSecurity_Secure::secure($_COOKIE); 		         
 	}
