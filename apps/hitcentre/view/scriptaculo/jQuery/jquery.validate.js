...
$.extend($.validator, {
	...
	messages: {
		...
		creditcard: "Por favor, um número de cartão de crédito válido.",
		equalTo: "Please enter the same value again.",
		accept: "Please enter a value with a valid extension.",
		maxlength: $.format("Por favor, insira não mais que {0} caracteres."),
		minlength: $.format("Por favor, insira no mínimo {0} caracteres."),
