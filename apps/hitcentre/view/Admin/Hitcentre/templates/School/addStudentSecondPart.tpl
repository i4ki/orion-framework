...
<script type="text/javascript" src="apps/hitcentre/view/scriptaculo/Admin/add_student_second_part.js"></script>
...
<body>
	<div id="container">
        ...
        <div id="wrapper">
			...
			{else}
				{include file="actions/School/Entries/addStudentNotRespSecondPart.tpl"}
			{/if}
            </div>
            </div>
            </div>
