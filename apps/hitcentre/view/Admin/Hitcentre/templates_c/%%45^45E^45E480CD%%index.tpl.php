<?php /* Smarty version 2.6.23, created on 2009-09-18 08:29:41
...
<body>
	<div id="container">
    	<div id="header">
        	<div id="title"><h2>Hit Centre of Language</h2></div>
        ...
        <div id="wrapper">
            <div id="content">
       			<div id="rightnow">
                    <h3 class="reallynow">
                        <span>Pendentes</span>
                        <a href="#" class="add">Nova Tarefa</a>
                        <a href="#" class="app_add">Ver pendências</a>
                        <br />
                    </h3>
				    <p class="youhave">Tarefas pendentes
                    </p>
			  </div>
            </div>
            </div>
