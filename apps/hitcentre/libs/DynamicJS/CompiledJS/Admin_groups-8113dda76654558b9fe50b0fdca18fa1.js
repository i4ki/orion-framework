document.charset = 'utf-8';
	...
	function loadResources( service, pattern ) {
		...
		Ajax.prototype.beforeSend = function() {
			$j('#divRoleResource').html('<br /><br /><center><img src="http://localhost/Orion/apps/hitcentre/view/Admin/Hitcentre/templates/img/ajax-loader.gif" /></center>');
		}
		...
		var ajax = new Ajax('http://localhost/Orion/Admin/Manager/Groups/Get/'+service+'/'+pattern+'/null/Ajax');
		ajax.send();
	...
	function savePermission() {
		...
		ajax = new Ajax('http://localhost/Orion/Admin/Manager/Groups/SavePermission/null/null/null/Ajax');
		ajax.send(null, data);
		disableNameGroup();
	}
	...
	function selectPerfil( role ) {
		Ajax.prototype.beforeSend = function() {
			$j('#loader').html('<img src="http://localhost/Orion/apps/hitcentre/view/Admin/Hitcentre/templates/img/ajax-loader.gif\" />');
		}
		Ajax.prototype.success = function( response ) {
			$j('#divRoleResource').html(response);
		}
