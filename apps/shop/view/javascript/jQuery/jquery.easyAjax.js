	...
	function Ajax(caller, options ) {
		...
		*/
		var options = jQuery.extend({
			...
			*/
			...
			beforeSend: function() {
					if(options.loader == true) {
						...
						caller.html('<center><img id="easyajax-loader" src="'+options.imageLoader+'" /></center>');
					}
			...
			*/
			loader: true,
			imageLoader: 'http://localhost/loja_nova/View/scriptaculo/jQuery/ajax-loader.gif',
			target: true,
			...
			typeResponse: 'fill',
				 ...
				 */					
			completeCallback: function() { /** Função chamada depois que a requisição
											*  estiver completa */
					return;
				},
